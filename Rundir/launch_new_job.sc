...
export p2input="$PERM/code/DATA/IN_ll_FGRN055_total_imp.txt"
export p2exe="$PERM/code/Program/"
export FDM_executable="IMAU-FDM_np_${myname}.x"
export homedir=`pwd`
gridpointlist="$homedir/pointlists/pointlist_${myname}.txt"    #pointlist_paper1_imp_newspin_todo.txt"
export ini_filename=""
export filename_part1="ECMWF_${outputname}"

# hardcoded FDM input
expname="era055/sensitivity_tests/${myname}"
