"""
Configuration for extend_pointfiles.py.

Controls how per-column FDM output from an original run and an extended run are
merged into combined per-point files spanning the full model period.
"""
