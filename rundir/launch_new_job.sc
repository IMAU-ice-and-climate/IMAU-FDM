...
export project_name="test_grainsize_true_rgrain_refreeze1mm_kg13" # set unique project_name; pointlist must have matching name e.g. pointlist_PROJECT_NAME.txt
