...
#reference_path = '/perm/nld3562/code/IMAU-FDM/reference/FGRN055/IN_ll_FGRN055.txt'
reference_path = '/perm/nld3562/code/IMAU-FDM/rundir/pointlists/pointlist_ANT27_3hourly.txt'
...
for i in range(len(loc_1d_done['string'])):
    ...
    string_1d = string_1d[len('/ec/res4/scratch/nld3562/ANT27_3hourly/output/ANT27_era055_1D_'):]
...
for i in range(len(loc_2d_done['string'])):
    ...
    string_2d = string_2d[len('/ec/res4/scratch/nld3562/ANT27_3hourly/output/ANT27_era055_2D_'):]
...
for i in range(len(loc_2ddet_done['string'])):
    ...
    string_2ddet = string_2ddet[len('/ec/res4/scratch/nld3562/ANT27_3hourly/output/ANT27_era055_2Ddetail_'):]
...
ints_todo = np.array(np.concatenate([ints_1d_todo, ints_2d_todo, ints_2ddet_todo]))
