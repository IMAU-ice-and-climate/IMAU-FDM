...
echo "$exe_id $usern $cpoint $domain $filename_part1 $project_name &> ${log_fname}" # TKTK RESTART IN PROGRESS 
$exe_id $usern $cpoint $domain $filename_part1 $project_name &> ${log_fname} # TKTK RESTART IN PROGRESS 
