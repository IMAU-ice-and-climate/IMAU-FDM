...
!			dtmodelExp,ImpExp)
    ...
    numSteps = dtobs/dtmodel        ! number of IMAU-FDM time steps per forcing time step
    numPoints = numTimes*numSteps   ! total number of IMAU-FDM time steps
    numPointsSU = numPoints*(REAL(nyearsSU)*365.25*24.*3600.)/(REAL(numTimes*dtobs)) ! total number of time steps per spin-up period
